        ...
        return (
            <div>
                <div className="card my-3" >
                    <span className="position-absolute top-0 translate-middle badge rounded-pill bg-danger text-white">{source}
                    </span>
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text"><small className="text-muted">By {author ? author : "Anonymous"} at {new Date(time).toGMTString()}</small></p>
